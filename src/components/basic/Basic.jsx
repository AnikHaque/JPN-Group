...
const Basic = () => {
  return (
    <div>
      <div className="px-4 py-16 mx-20 sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="grid max-w-screen-lg gap-8 lg:grid-cols-2 sm:mx-auto">
          ...
          <div className="grid grid-cols-2 ml-28 w-[900px] gap-5 ">
            <img
